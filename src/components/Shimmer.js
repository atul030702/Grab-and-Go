...
const CardShimmer = () => {
    return (
        <div className="shimmer flicker w-[285px] h-[300px] flex flex-col justify-center items-center bg-gray-200 p-2.5 rounded-xl gap-1">
...
export const MenuShimmer = () => {
    return (
        <div className="flicker flex flex-col w-[850px] justify-between items-start bg-gray-50 m-auto">
            <div className="flicker w-full h-55 flex justify-start items-center mb-2.5 bg-gray-100">
                <div className="flicker w-62 h-44 rounded-[5px] m-4 bg-gray-300"></div>
                <div className="flicker flex flex-col m-5 h-44 w-63 bg-gray-100">
                    <div className="flicker w-full h-15 bg-gray-300"></div>
                    <div className="flicker w-full h-5 bg-gray-300"></div>
                    <div className="flicker w-full h-12 bg-gray-300"></div>
                    <div className="flicker w-full h-6 bg-gray-300"></div>
                    <div className="flicker w-full h-6 bg-gray-300"></div>
                </div>
            </div>
            <div className="flicker flex flex-col justify-center items-start w-full mt-5 bg-gray-100">
                ...
                {Array(shimmer_menuCard_unit).fill("").map((_, index) => (
                    <div key={index.toString() + 1} className="flicker w-full h-[150px] mb-2.5 flex bg-gray-200 gap-2.5 justify-between items-center">
                        <div className="flicker h-36 bg-gray-300"></div>
                        <div className="flicker rounded-[5px] w-46 h-36 p-1 bg-gray-300"></div>
                    </div>
                ))}
            </div>
        </div>
