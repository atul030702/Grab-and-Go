...
const AboutMe = () => {
    ...
    return (
        ...
        >
            ...
            <img src={myImage} alt="profile-icon" draggable="false" className="size-[150px] m-[5px] rounded-[50%]"/>
            ...
            <div className="flex justify-center items-center">
                ...
                >
                    <img src={linkedInIcon} alt="linkedin-icon" draggable="false" className="size-[41px]"/>
                </a>
                <a href="https://github.com/atul030702/" target="_blank" rel="noopener noreferrer" title="GitHub"
                    className="m-[5px] hover:scale-[1.1]"
                >
                    <img src={gitHubIcon} alt="github-icon" draggable="false" className="size-[40px]"/>
                </a>
            </div>
        </div>
